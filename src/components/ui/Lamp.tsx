  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 to-br from-slate-300 to-slate-500 py-4  text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] conicvia-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] conic [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <div className="absolute top-1/2 z-50 h-48 w-full nt opacity-10 backdrop-blur-md"></div>
